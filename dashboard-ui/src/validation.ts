...
const SPECS: Record<string, Spec> = {
  ...
  daily_loss_limit_pct: { key: "daily_loss_limit_pct", type: "float", hardMin: 0, hardMax: 100, softMin: 1, softMax: 20, unit: "%" },
  max_consecutive_losses: { key: "max_consecutive_losses", type: "int", hardMin: 0, hardMax: 50, softMin: 2, softMax: 10 },
