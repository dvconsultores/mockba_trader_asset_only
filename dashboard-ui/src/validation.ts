...
const SPECS: Record<string, Spec> = {
  ...
  dex_slot_pct: { key: "dex_slot_pct", type: "float", hardMin: 0.1, hardMax: 100, softMin: 2, softMax: 50, unit: "%" },
  cex_slot_pct: { key: "cex_slot_pct", type: "float", hardMin: 0.1, hardMax: 100, softMin: 2, softMax: 50, unit: "%" },
  max_slots_dex: { key: "max_slots_dex", type: "int", hardMin: 1, hardMax: 100, softMin: 1, softMax: 20 },
  max_slots_cex: { key: "max_slots_cex", type: "int", hardMin: 1, hardMax: 100, softMin: 1, softMax: 20 },
  capital_cex_usdt: { key: "capital_cex_usdt", type: "float", hardMin: 0, softMin: 0, unit: "$" },
  capital_dex_usdc: { key: "capital_dex_usdc", type: "float", hardMin: 0, softMin: 0, unit: "$" },
  universe_scan_interval_hours: { key: "universe_scan_interval_hours", type: "int", hardMin: 1, hardMax: 720, softMin: 6, softMax: 168, unit: "hours" },
  universe_max_age_hours: { key: "universe_max_age_hours", type: "int", hardMin: 1, hardMax: 720, softMin: 12, softMax: 168, unit: "hours" },
  universe_size: { key: "universe_size", type: "int", hardMin: 1, hardMax: 200, softMin: 5, softMax: 50 },
  universe_min_volume_usd: { key: "universe_min_volume_usd", type: "float", hardMin: 0, softMin: 1000000, unit: "$" },
  universe_spread_ratio_max: { key: "universe_spread_ratio_max", type: "float", hardMin: 0.01, hardMax: 1, softMin: 0.05, softMax: 0.25 },
  universe_rank_min: { key: "universe_rank_min", type: "int", hardMin: 1, hardMax: 500, softMin: 5, softMax: 100 },
  universe_rank_max: { key: "universe_rank_max", type: "int", hardMin: 1, hardMax: 2000, softMin: 30, softMax: 500 },
  universe_depth_slot_multiple: { key: "universe_depth_slot_multiple", type: "float", hardMin: 0.1, hardMax: 20, softMin: 1, softMax: 10, unit: "x" },
  universe_replay_days: { key: "universe_replay_days", type: "int", hardMin: 1, hardMax: 90, softMin: 3, softMax: 30, unit: "days" },
  universe_min_signals: { key: "universe_min_signals", type: "int", hardMin: 1, hardMax: 1000, softMin: 10, softMax: 200 },
  universe_min_recovery_rate: { key: "universe_min_recovery_rate", type: "str" },
  universe_spread_degradation_multiple: { key: "universe_spread_degradation_multiple", type: "float", hardMin: 1, hardMax: 50, softMin: 1.5, softMax: 10, unit: "x" },
